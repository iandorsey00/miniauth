...
- MiniAuth now also uses a dedicated lock app icon and a quieter top-left auth header pattern on sign-in, verification, and password-setup flows so branding feels more consistent with the wider app family.
